...
import '../customer_acknowledgement/add_acknowledgement.dart';
import '../toner_request/add_request.dart';
...
class _CategoriesDashboardState extends State<CategoriesDashboard> {
  ...
  Future<String?> getUserRole() async {
    try {
      return await PrefManager().getUserRole();
    } catch (e) {
                  ...
                  child: ResponsivePadding(
                    child: Column(
                      ...
                      children: [
                        ...
                        MetricsGrid(
                          data: data,
                          getCategoryMetric: getCategoryMetric,
                        ),
                        SizedBox(height: MediaQuery.of(context).size.height * 0.04),
...
class ResponsivePadding extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final padding = isSmallScreen ? 16.0 : isMediumScreen ? 20.0 : 24.0;
...
// Responsive Client Action Grid
class ResponsiveClientActionGrid extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
              ...
              return ClientActionCard(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const AddAcknowledgement(),
                    ),
                  );
                },
              );
...
class SupportContactCard extends StatefulWidget {
  const SupportContactCard({Key? key}) : super(key: key);
...
class _SupportContactCardState extends State<SupportContactCard> {
  bool _copied = false;
  final String _emailAddress = 'dpssupport@monotech.in';

  void _copyToClipboard() {
    final data = ClipboardData(text: _emailAddress);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'If you need any other assistance, please reach out to our support team at the email below.',
                  style: TextStyle(
                ...
                GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: _copied
                          ? colorFirstGrad.withOpacity(0.15)
                          : colorFirstGrad.withOpacity(0.08),
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
                        color: _copied
                            ? colorFirstGrad
                            : colorFirstGrad.withOpacity(0.3),
                        width: _copied ? 1.5 : 1,
                      ),
                    ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Row(
                            children: [
                              Icon(
                                _copied ? Icons.check_circle : Icons.email,
                                color: colorFirstGrad,
                ...
                Padding(
                  ...
                  child: Text(
                    _copied ? '✓ Copied to clipboard' : 'Tap to copy email',
                    style: TextStyle(
                      fontSize: isSmallScreen ? 11 : 12,
                      color: _copied ? Colors.green[600] : Colors.grey[500],
...
class MetricsGrid extends StatelessWidget {
  ...
  const MetricsGrid(
      {Key? key, required this.data, required this.getCategoryMetric})
      : super(key: key);
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            final metric = getCategoryMetric(index, data);
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: SingleChildScrollView(
                    scrollDirection: Axis.horizontal,
                    child: SizedBox(
                      width: constraints.maxWidth > 400 ? constraints.maxWidth - (padding * 2) - 32 : 600,
                      child: LineChart(
                        LineChartData(
                          gridData: FlGridData(
                            show: true,
    ...
    return [
      LineChartBarData(
        spots: data
            ...
            .entries
            .map((e) =>
            FlSpot(e.key.toDouble(), parseValueSafely(e.value.receive)))
            .toList(),
        isCurved: true,
        color: const Color(0xFF1E88E5),
        barWidth: 3,
      ...
      LineChartBarData(
        spots: data
            ...
            .entries
            .map((e) =>
            FlSpot(e.key.toDouble(), parseValueSafely(e.value.dispatch)))
            .toList(),
        isCurved: true,
        color: const Color(0xFFE91E63),
        barWidth: 3,
      ...
      builder: (context, constraints) {
        return SingleChildScrollView(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: const [
              LegendItem(label: 'Receive', color: Color(0xFF1E88E5)),
              SizedBox(width: 24),
              LegendItem(label: 'Dispatch', color: Color(0xFFE91E63)),
            ],
          ),
        );
      },
